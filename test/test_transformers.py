...
class TestTransformers(NNTestCase):
    ...
    @unittest.skipIf(not PLATFORM_SUPPORTS_FUSED_SDPA or not SM80OrLater, "platform does not supposrt SDPA or pre-SM80 hardware")
...
class TestSDPA(NNTestCase):
    ...
    @unittest.skipIf(not PLATFORM_SUPPORTS_FUSED_SDPA, "does not support fused SDPA")
    ...
    @unittest.skipIf(not PLATFORM_SUPPORTS_FUSED_SDPA or not isSM86Device, "does not support fused SDPA or not SM86")
    ...
    @unittest.skipIf(not PLATFORM_SUPPORTS_FUSED_SDPA or not SM80OrLater, "does not support SDPA or pre-SM80")
    ...
    @unittest.skipIf(not PLATFORM_SUPPORTS_FUSED_SDPA or not SM80OrLater, "not SDPA or pre-SM80")
